...
('olg-12x18-rolled',
 'Our Lady of Guadalupe — 12"x18" Rolled Canvas',
 'The Church-authorized tilma image printed on archival canvas at 12"x18" and shipped rolled in a protective tube. Ready for your own framing. Includes certificate of authenticity.',
 '12x18', 'rolled', 4300, '/products/olg-12x18-rolled.jpg', 20),
('olg-24x36-rolled',
...
UPDATE products SET active = FALSE
 WHERE sku NOT IN (
    ...
    'olg-12x18-rolled', 'olg-24x36-rolled', 'olg-36x54-rolled'
 );
