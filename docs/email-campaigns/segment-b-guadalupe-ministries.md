# Segment B — Guadalupe / Hispanic Ministries at Catholic Parishes

For Guadalupe and Hispanic ministries at parishes not specifically named for Our Lady of Guadalupe. Same cadence and offer as Segment A, but framed around the ministry rather than the parish patronage.
...
## Email 2 — The image itself (value, not sales)

**Send:** Day 4

**Subject:** What the Aztecs read in the Guadalupe image

**Preview text:** Every fold, sash, and star was a message. A short read for your ministry or December 12 preparation.
...
For ministries that would like the image itself, we make a 24" × 36" rolled canvas — printed in the USA from the same authenticated high-resolution scan of the tilma — available for $114, with free U.S. shipping and two Mexican certificates of authenticity.
...
## Email 3 — Ministry use / final CTA
...
The 24" × 36" rolled canvas we make has been ordered by parish ministries for:

- The parish's Guadalupe shrine
- December 12 processions and vigil Masses
- Hispanic ministry meeting spaces and offices
- Religious education classrooms — especially for December catechesis
- The rectory or parish office
