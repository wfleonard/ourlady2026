# Segment C — Catholic Schools

For Catholic schools (K–12, and independent Catholic high schools) with meaningful Hispanic enrollment or a Guadalupe/Marian devotional culture. Same 3-email cadence as Segments A and B, framed for a school audience — multiple classrooms, chapel/gym space, curriculum tie-ins, bulk pricing.

**Recommended send window:** early-to-mid October — before religion departments finalize Advent and Dec 12 lesson planning.

---

## Roles to target (in order)

1. **Religion department chair** or lead religion teacher (best match)
2. **Campus ministry director**
3. **Principal / Head of School** (decision authority for bulk orders)
4. **Hispanic ministry / diversity coordinator** (larger schools)
5. **Advancement or development office** (for graduation-gift or class-legacy angle)
6. **General school info address** (fallback only)

## Personalization variables

Same base set as Segments A and B, plus school-specific fields:
...
## Email 2 — Curriculum / value

**Send:** Day 4

**Subject:** Two Guadalupe resources for your Dec 12 lesson plans

**Preview text:** Symbolism the Aztecs read, and the science that cannot explain the tilma. Free reading for religion, history, and Spanish classes.
...
## Email 3 — School use cases / final CTA
...
The 24" × 36" rolled canvas we make has been ordered by Catholic schools for:

- Religion education classrooms (one per teacher — most common)
- The school chapel or prayer room
- Main hallway or lobby
- Library beside a Marian book display or Latin American history section
- Cafeteria or student commons for December
- Faculty lounge and administrative offices
- Dec 12 processions and school Mass
